...
Revision ID: cdcf6a4e03e1
Revises: 
Create Date: 2025-10-07 11:13:59.772348
...
def upgrade():
    ...
    op.create_table('coupons',
        ...
        sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', 'EXPIRED', name='couponstatus'), nullable=True),
    ...
    # 2. Tables depending on users or categories
    ...
    # 4. Tables depending on orders or products
    ...
    # 5. Finally, coupon_usage (depends on orders, coupons, users)
