/**
 * Generates SVG placeholders for each product in src/data/sampleProducts.json
 * and updates the product.image_url to point to /images/<slug>.svg
 *
 * Usage: node scripts/gen_product_svgs_and_update_json.js
 */
const fs = require('fs');
...
products.forEach(p => {
  ...
  // Simple electronics-styled SVG: gradient background + product name + category
